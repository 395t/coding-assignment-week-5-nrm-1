...
class TransformerEncoderBatchNorm(nn.Sequential):
    def __init__(self, depth: int = 12, **kwargs):
        super().__init__(*[TransformerEncoderBlockBatchNorm(**kwargs) for _ in range(depth)])

class TransformerEncoderInstanceNorm(nn.Sequential):
    def __init__(self, depth: int = 12, **kwargs):
...
class ViTBatchNorm(nn.Sequential):
    def __init__(self,     
                in_channels: int = 3,
                patch_size: int = 16,
                emb_size: int = 240,
...
class ViTInstanceNorm(nn.Sequential):
    def __init__(self,     
                in_channels: int = 3,
                patch_size: int = 16,
                emb_size: int = 240,
